...
namespace SimpleCalculatorApp
{
    public partial class MainForm : Form
    {
        ...
        private void buttonAdd_Click_TMP(object sender, EventArgs e)
        {
            int firstNumber;
            int secondNumber;
            if (Validate(textBoxFitstNumber.Text, textBoxSecondNamber.Text,
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            int firstNumber;
            int secondNumber;
            if (int.TryParse(textBoxFitstNumber.Text, out firstNumber) && int.TryParse(textBoxSecondNamber.Text, out secondNumber))
            {
            ...
            {
                labelResult.Text = "Podano nieprawidlowe dane.";
            }
        }
